...
from ecommerce.drf.utils import  *
import json
...
def test_get_inventory_by_web_id(api_client, single_sub_product_with_media_and_attibutes):
    
    fixture = convert_to_dot_notation(single_sub_product_with_media_and_attibutes)
